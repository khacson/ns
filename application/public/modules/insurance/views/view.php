	    ...
	    <div class="row">
			<div class="col-md-4">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('bao-hiem-kpcd');?></label>
					<div class="col-md-8">
						<input type="text" name="insurance_name" placeholder="<?=getLanguage('nhap-bao-hiem-kpcd');?>" id="insurance_name" class="searchs form-control tab-event" />
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="insurance_value" placeholder="<?=getLanguage('nhap-so-tien');?>" id="insurance_value" class="searchs form-control fm-number tab-event" />
					</div>
				</div>
			</div>
			<div class="col-md-4">
			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th><?=getLanguage('bao-hiem-kpcd');?></th>
						<th><?=getLanguage('so-tien');?></th>
						<th><?=getLanguage('loai');?></th>
						<th></th>
						<th></th>
					</tr>
				</table>
...
<script>
	...
	function save(id,func){
		...
		if(obj.insurance_name == ""){
			warning('<?=getLanguage('bao-hiem-kpcd-khong-duoc-trong');?>'); 
			$("#insurance_name").focus();
			return false;		
		}
		if(obj.insurance_value == ""){
			warning('<?=getLanguage('tien-bao-hiem-kpcd-khong-duoc-trong');?>'); 
