	    ...
	    <div class="row">
			<div class="col-md-4">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('thang-nam');?></label>
					<div class="col-md-8">
						<input type="text" name="monthyear" placeholder="<?=getLanguage('nhap-thang-nam');?>" id="monthyear" class="searchs form-control tab-event" />
					</div>
				</div>
			</div>
		</div>
