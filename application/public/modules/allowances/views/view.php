	    ...
	    <div class="row">
			<div class="col-md-4">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('phu-cap');?></label>
					<div class="col-md-8">
						<input type="text" name="allowance_name" placeholder="<?=getLanguage('nhap-phu-cap');?>" id="allowance_name" class="searchs form-control tab-event" />
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="allowance_money" placeholder="<?=getLanguage('nhap-loai-phu-cap');?>" id="allowance_money" class="searchs form-control fm-number tab-event" />
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					...
					<div class="col-md-8">
						<select id="allowance_type" name="allowance_type" class="combos" >
...
<script>
	...
	function save(id,func){
		...
		if(obj.allowance_money == ""){
			warning('<?=getLanguage('tien-phu-cap-khong-duoc-trong');?>'); 
			$("#allowance_money").focus();
			return false;		
		}
		$('.loading').show();
