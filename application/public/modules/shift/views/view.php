	    ...
	    <div class="row">
			<div class="col-md-4">
				<div class="form-group">
					<label class="control-label col-md-4"><?=getLanguage('ca-lam-viec');?></label>
					<div class="col-md-8">
						<input type="text" name="shift_name" placeholder="<?=getLanguage('nhap-ca-lam-viec');?>" id="shift_name" class="searchs form-control tab-event" />
					</div>
				</div>
			</div>
		</div>
			...
			<div id="tHeader">    	
				<table width="100%" cellspacing="0" border="1" class="table ">
					...
					<tr>
						...
						<th><?=getLanguage('bat-dau');?></th>
						<th><?=getLanguage('ket-thuc');?></th>
						<th></th>
						<th></th>
					</tr>
				</table>
