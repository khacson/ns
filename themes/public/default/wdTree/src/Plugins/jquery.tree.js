...
(function($) {
    ...
    $.fn.treeview = function(settings) {
        ...
        function buildtree(data, ht) {
            ...
            ht.push("<ul id='sroot' class='bbit-tree-root ", dfop.theme, "'>"); //root
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            ht.push("<li id='litree' class='bbit-tree-node'>");
            ...
            ht.push("<img style='display:nones' class='bbit-tree-node-icon total_item' src='" + dfop.cbiconpath + "s.gif'/>");
            //checkbox
        ...
        function check(item, state, type) { //console.log(1);
